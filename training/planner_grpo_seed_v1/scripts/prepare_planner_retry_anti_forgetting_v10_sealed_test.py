#!/usr/bin/env python3
"""Open the committed V10 sealed test only after target checkpoint selection."""
...
STUDY_DIR = ROOT / "experiments/studies/planner_retry_anti_forgetting_v10_qwen35_4b_v1"
DATASET_MANIFEST = ROOT / "data/datasets/planner_retry_anti_forgetting_v10/manifest.json"
BUILDER = ROOT / "training/planner_grpo_seed_v1/scripts/build_planner_retry_anti_forgetting_v10.py"
DEFAULT_MODEL = Path("/raid/zkq/models/Qwen3.5-4B")
PREREGISTERED_CHECKPOINTS = {2, 5, 10}
